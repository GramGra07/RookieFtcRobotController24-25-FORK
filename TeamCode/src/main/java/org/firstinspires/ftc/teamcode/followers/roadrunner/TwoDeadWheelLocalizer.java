...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -1293.2480470141352; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 7.439829215993213; // x position of the perpendicular encoder (in tick units)
    }
